...
import org.zaproxy.zap.extension.recordsattack.RecordsAttackResultsTableModel.ProcessedCellItem;
import org.zaproxy.zap.extension.recordsattack.SpiderListener.ResourceState;
import org.zaproxy.zap.view.table.HistoryReferencesTable;

public class RecordsResultsTable extends HistoryReferencesTable {
    ...
    public RecordsResultsTable(RecordsAttackResultsTableModel resultsModel) {
        super(resultsModel);
    ...
    private static class ProcessedCellItemIconHighlighter extends AbstractHighlighter {
        ...
        private static final ImageIcon PROCESSED_ICON =
                new ImageIcon(RecordsResultsTable.class.getResource("/resource/icon/16/152.png"));

        /** The icon that indicates the entry was not processed. */
        private static final ImageIcon NOT_PROCESSED_ICON =
                new ImageIcon(RecordsResultsTable.class.getResource("/resource/icon/16/149.png"));
